...
"""
# Author: zhao zhishan
# Created Time : 2021-01-16 15:19
# File Name: models/deepfm.py
# Description:
"""
...
class Model(BaseModel):
    ...
    def _model_fn(self, feat_idx, feat_val):
        ...
        with tf.variable_scope('deepfm', reuse=tf.AUTO_REUSE):
            ...
            fm_logits = tf.add_n([first_order_output, second_order_output]) + bias
            # dnn
